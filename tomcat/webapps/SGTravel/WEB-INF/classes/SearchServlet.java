...
import javax.servlet.http.*;
 ...
 @WebServlet("/search")
public class SearchServlet extends HttpServlet {  // JDK 6 and above only
   ...
   public void doGet(HttpServletRequest request, HttpServletResponse response)
      ...
      try {
         ...
         // out.println("<p>You search is: " + sqlStr + "</p>"); // Echo for debugging
        ...
        int planCount = 1;
         while(rset.next()) {
            ...
            out.println(  "<head>Recommendation</head> "+ planCount
